 ...
 * @author webthethird
 * @notice Based on https://github.com/gnosis/util-contracts/blob/main/contracts/storage/StorageSimulation.sol
 */
contract CallSimulator is ISimulator, Ownable {
    /**
    ...
    // Allow receiving ether from limit order module in simulations
