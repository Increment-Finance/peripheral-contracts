# IAuctionModule
[Git Source](https://github.com/Increment-Finance/peripheral-contracts/blob/7b4166bd3bb6b2c678b84df162bcaf7af66b042d/contracts/interfaces/IAuctionModule.sol)
...
*Lot size starts at `auction.initialLotSize` and increases by `auction.lotIncreaseIncrement` every
...
*First the SafetyModule slashes the StakedToken, sending the underlying slashed tokens here*
...
### AuctionModule_CannotReplacePaymentTokenActiveAuction
Error returned when governance tries to change the payment token while an auction is active
...
### AuctionModule_TokenAlreadyInAuction
